...
export {AXIOS_ERROR,screenshotTime,AXIOS_OK,AXIOS_NO_DATA,ScreenWidth,ServerLink,SERVER_AUTH_FAILED,SERVER_REGISTER_FAILED,Authenticated_Server_Link}
